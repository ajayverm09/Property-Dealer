    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl text-center mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center flex-wrap gap-3">
          ...
          <select className="border hover:bg-black hover:text-white rounded-md p-2 w-48">
        ...
        <div className="flex justify-center mt-12 gap-3">
          <button
            ...
            className="border hover:bg-blue-800 hover:text-white rounded-md p-2 w-48">
            Residential Properties</button>
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <button className="mt-4 bg-red-600 hover:bg-red-800 text-white w-full py-2 rounded">Read More</button>
          </div>
