    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="bg-white shadow-lg rounded-lg p-6 mb-10">
        <img
          src={blog.image}
          alt={blog.title}
          className="w-40 h-40 object-cover rounded-full border-4 border-blue-300 mb-6 mx-auto"
        />
        <Link to="/blog" className="hover:text-black transition">
          <button className="bg-green-400 ml-[970px] -mb-20 rounded-3xl h-10 w-32 hover:bg-green-700 hover:text-white">
            Back to Blogs
          </button>
        </Link>
        ...
        {otherBlogs.map((b) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-700 line-clamp-3">{b.excerpt}</p>
            </div>
          </Link>
        ))}
      </div>
