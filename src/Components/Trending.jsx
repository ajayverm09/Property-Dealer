  ...
  return (
    <div>
      <section className="py-10 px-4 max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-gray-800 text-center sm:text-left">
          Trending Properties
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            <img
              ...
              className="w-full h-48 sm:h-56 md:h-64 object-cover rounded mb-3"
              alt="Whiteland Blissville"
            />
            <h3 className="text-base sm:text-lg font-semibold">Whiteland Blissville</h3>
          ...
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            ...
            />
            <h3 className="text-base sm:text-lg font-semibold">Mapsko Mount Ville</h3>
          ...
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            <img
              ...
              alt="M3M Cullinan"
            />
            <h3 className="text-base sm:text-lg font-semibold">M3M Cullinan</h3>
          ...
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            ...
            />
            <h3 className="text-base sm:text-lg font-semibold">Puri The Aravallis</h3>
          ...
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            <img
              ...
              alt="Godrej Nest"
            />
            <h3 className="text-base sm:text-lg font-semibold">Godrej Nest</h3>
          ...
          <div className="border p-4 shadow-md rounded-lg cursor-pointer transition duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
            ...
            />
            <h3 className="text-base sm:text-lg font-semibold">ATS Kinghood Drive</h3>
