...
function ContactPage() {
  return (
    <div>
        ...
        style={{ backgroundImage: "url('https://manchandarealtors.com/wp-content/uploads/2021/06/contact-us-1-scaled.jpg?id=5538')" }}>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-8">
        <div className="border rounded-lg p-6 shadow-md">
          ...
          <p className="text-gray-700">
            📍 <span className="font-semibold">Address:</span> # 36A & 36B, Ground Floor,
            Edmonton Shopping Mall, Hotel THE BRISTOL, M.G Road, Gurugram-122002 (Haryana)
          </p>
        </div>
