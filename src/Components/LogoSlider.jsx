...
function LogoSlide() {
  return (
    <section className="bg-white py-8 text-center px-4">
      <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-4">OUR CLIENTS</h2>
      <button className="bg-blue-600 text-white px-4 py-2 md:px-6 md:py-2 font-medium rounded mb-6">
        VIEW ALL
      </button>
      <h3 className="text-xl md:text-2xl font-medium text-gray-800 mb-8">
        ASSOCIATED WITH DEVELOPERS
        <div className="h-1 w-16 md:w-20 bg-blue-500 mx-auto mt-2"></div>
      </h3>
        ...
        >
          {logos.map((logo, index) => (
            <SwiperSlide key={index}>
              <div className="p-3 bg-white border rounded shadow-sm flex items-center justify-center h-16 md:h-20">
                <img
                  src={logo.src}
                  alt={logo.alt}
